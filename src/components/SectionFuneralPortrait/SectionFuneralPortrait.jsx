      ...
      <div className={`container ${s.funeralPortrait__container}`}>
        ...
        <BanerForSection
          ...
          imgBannerDescription={imgBannerDescription}
              ...
              <p className='description'>Прижиттєвий портрет покійного на похороні символізує вічне життя його душі та пам'яті про нього у серцях усіх членів сім'ї, друзів та колег. Він ніби живий вічно дивиться зі своєї фотографії на всіх присутніх на церемонії прощання з його фізичним тілом, при цьому залишаючись з рідними на духовному рівні.</p>
              ...
              <p className='description'>Зробити траурний фотопортрет для церемонії прощання можна в будь-якому фотоательє або навіть поліграфічному центрі, використовуючи прижиттєву фотографію покійного. Проте люди вмирають незалежно від часу доби та дня тижня. Такі фотопослуги надають лише у робочі години, а в процесі організації похорону важлива кожна хвилина, оскільки турбот багато, а часу катастрофічно не вистачає.</p>

              <p className='description'>Ритуальне бюро «Омега» займається комплексною організацією похорону та працює у цілодобовому режимі без вихідних. Це означає, що ми можемо взяти на себе всі турботи щодо планування церемонії прощання та купівлі необхідної похоронної атрибутики. Наші фотомайстри створять гідний портрет покійного, виходячи з наданого родичами фото покійного.</p>
              ...
              <ul className='list'>
                  <li className='listItem'>Багатий і урочистий портрет, створений художником на основі фотографії, говорить про високий статус покійного та велику повагу до нього його рідних та близьких друзів.</li>
                  <li className='listItem'>Ретушований фотопортрет великого формату також можна використовувати на урочистому похороні статусної людини, де планується присутність багатьох людей.</li>
                  <li className='listItem'>Оброблене фото середнього формату із чорною жалобною стрічкою – це недорогий бюджетний варіант похоронного фотопортрета, який анітрохи не применшує шану та повагу до покійного.</li>
              </ul>
